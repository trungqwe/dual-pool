...
| P2-ENTRY-ACL-001 / P2-ACL-CREATION-001 / P2-ACL-INHERITANCE-001 / P2-ACL-INSPECTION-001; SEC-002 / NFR-010 / T-02 ACL boundary | [ACL implementation and tests](../internal/winacl/), [real ACL gate](../evidence/phase-2-product-init/acl-gate.json) | PASS; creation-time protected DACL, exact current-user/SYSTEM ACEs and seven children |
| P2-ENTRY-KEYS-001 / P2-KEY-INIT-001 / P2-KEY-PARTIAL-RECOVERY-001 / P2-KEY-IDEMPOTENCE-001; SEC-002 key boundary | [initializer tests](../internal/productinit/init_test.go), [real key gate](../evidence/phase-2-product-init/key-gate.json) | PASS; four distinct 32-byte keys, 0–4 reconciliation, no rotation on retry |
| P2-KEY-NONDISCLOSURE-001 / P2-PRODUCT-INIT-LIVE-001; NFR-010 / T-02 product boundary | [gated real test](../internal/productinit/real_windows_test.go), [real initialization](../evidence/phase-2-product-init/real-initialization.json), [security gate](../evidence/phase-2-product-init/security-gate.json) | PASS for product initializer; later config, doctor and provider surfaces remain open |
| P2-STAGER-REDIRECT-PORT-001 | [redirect regression](../internal/upstreamstage/stage_test.go), [test result](../evidence/phase-2-product-init/test-result.json) | PASS; explicit allowed-host ports rejected |
| P2-LOCK-CONSUME-001 | [Go lock tests](../internal/upstreamlock/lock_test.go), [Node validator tests](../scripts/phase0-upstream-lock.test.cjs) | E3 PASS; exact lock bytes bind the stage manifest |
| P2-DOWNLOAD-ORIGIN-001 / P2-DOWNLOAD-HASH-001 | [stager tests](../internal/upstreamstage/stage_test.go), [security gate](../evidence/phase-2-upstream-stager/security-gate.json) | E3 PASS; exact HTTPS release path, allowlisted redirects, bounded streaming and fail-closed SHA-256 |
| P2-ARCHIVE-SAFETY-001 / P2-EXEC-HASH-001 | [archive tests](../internal/upstreamstage/stage_test.go), [pinned result](../evidence/phase-2-upstream-stager/pinned-integration.json) | E3 PASS; ZIP safety and unique executable hash selection |
...
| P2-UPD-LIFECYCLE-001: no nested GLOBAL acquisition | private `instance.updaterLifecycle` composed only by `instance.ComposeUpdater`, [lock topology](../evidence/phase-2-updater-manager-composition/lock-topology.json) | PASS_COMPONENT |
